...
//		readVillagetr("/11/01/01/110101001.html");
		...
		String codeCity="500100000000";
		String codeCou="500235000000";
		String codeS="500235140000";
...
//				saveData(2, id1, provinceName, "0,1", txt2[0]);
			}
			for(Element e33 : e3){//区
				...
				int id2 = 0;
				if("县".equals(txt2[1])){
					id2 = getData(provinceName, "500100000000");
				}else{
					id2 = getData(provinceName, txt2[0]);
				}
...
//						Thread.sleep(1000);
	...
	public static Elements readProvince(String strUrl,int index) throws IOException{
		...
		Document doc = Jsoup.connect(proUrl).header(userAgent,value).timeout(5000).get();
